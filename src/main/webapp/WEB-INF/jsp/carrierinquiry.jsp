...
var CountPage;//总页数
   ...
   $(function(){	
	   ...
	   $("#inquirybtn").click(function(){
	  	...
	  	function a(){	
	  		var path="../inquiry/getSelect"; 				
	  		var in_number=$("#inquiryval").val();
	  		 
	  		$.post(path,{"in_number":in_number},function(data){	
	  			 Count=data.length;//总数量
				 CountPage=Math.ceil(Count/6);
	 			 $("#fontpage1").html(CountPage);
	  		var string="<thead><tr><th>序号</th><th>订单号</th><th>内容</th><th>时间</th><th>操作</th></tr></thead>";
	  			for(var  i=6*(CurrPage-1);i<=6*CurrPage-1;i++){
	 				if(i<=Count-1&&i>=0){			
	  				var num=i+1;
	  			    var id=data[i].i_id;				
	  				var i_number=data[i].i_number;
	  				var i_instruction=data[i].i_instruction;  			
	  				var i_time=data[i].i_time;	
	  				
	  				var delet="<td class=delete id="+id+"><font class=xiu>删除</font></td>";
	  				string+="<tbody><tr><td>"+num+"</td><td>"+i_number+"</td><td>"+i_instruction+"</td><td>"+i_time+"</td>"+delet+"<tr></tbody>";	
	  			}}
	  		...
	  		$(".tablelist").on("click",".delete",function(){	
	  	 		...
	  	 		var falg=confirm("你确定删除吗");
	  	 				if(falg==false){
	  	 					...
	  	 					var paths="../inquiry/deleteInquiry";
	  	 					$.post(paths,{"id":id},function(data){
	  	 					 Count=data.length;//总数量
	  						 CountPage=Math.ceil(Count/6);
	  			 			 $("#fontpage1").html(CountPage);
	  	 						var string="<tr><th>序号</th><th>订单号</th><th>内容</th><th>时间</th><th>操作</th></tr>";
	  	 			  			for(var  i=6*(CurrPage-1);i<=6*CurrPage-1;i++){
	  	 			 				if(i<=Count-1&&i>=0){			
	  	 			  				var num=i+1;
	  	 			  			    var id=data[i].i_id;				
	  	 			  				...
	  	 			  				var delet="<td class=delete id="+id+"><font class=xiu>删除</font></td>";
	  	 			  				string+="<tr><td>"+num+"</td><td>"+i_number+"</td><td>"+i_instruction+"</td><td>"+i_time+"</td>"+delet+"<tr>";	
	  	 			  			}}
	  	 						$(".tablelist").html(string);
	...
	<div class="head clearfix">
        ...
        <div class="menu">
            ...
            <ul class="clearfix">
                ...
                <li class="now"><a href="../CommCon/carrierinquiry">物流管理</a></li>
...
<div class="main">
    ...
    <ul class="forminfo">
    <li><label>订单编号<b>*</b></label><input name="i_number"  type="text" class="dfinput"  placeholder="填写物件的订单号" style="width:518px;"/></li>
    <li><label>通知内容<b>*</b></label>
    <textarea id="i_instruction" name="content" style="width:700px;height:150px;border: 1px solid gainsboro;"></textarea> 
    </li>
    ...
    <ul class="seachform">   
    <li><label>订单号查询</label><input name="" type="text" class="scinput" id="inquiryval" /></li>
