...
<body style="background:#fff3e1;">
    ...
    <span><img src="../img/leftico01.png" /></span>管理信息
        ...
        <li>
            <div class="header">
            <cite></cite>
            <a href="../CommCon/index" target="rightFrame">首页模版</a>
            <i></i>
            </div>
        </li>
        ...
        <li><div class="header"><cite></cite><a href="../CommCon/imgtable" target="rightFrame">图片数据表</a><i></i> </div> </li>
        <li><div class="header"><cite></cite><a href="../CommCon/form" target="rightFrame">个人信息</a><i></i> </div> </li>
        <li><div class="header"><cite></cite><a href="../CommCon/imglist" target="rightFrame">图片列表</a><i></i> </div> </li>              
